  ...
  return (
    ...
    <div className="bg-zinc-900 mx-auto text-center w-full">
      ...
      <div className="relative mx-auto block">
        ...
        <FontAwesomeIcon icon={faMagnifyingGlass} className="bg-purple-400 shadow-xl rounded-full p-4 absolute -mx-10 my-8 cursor-pointer transition hover:bg-amber-200 active:outline-dashed active:outline-indigo-400 outline-4" size="xl" color="#18181b" onClick={onSearchIconClick} />
      </div>
    </div>
